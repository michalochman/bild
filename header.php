...
<head>
    ...
    <link href="<?php echo get_template_directory_uri(); ?>/fonts/calendas/stylesheet.css" rel="stylesheet" media="screen">
    <link href="<?php echo get_template_directory_uri(); ?>/css/screen.css" rel="stylesheet" media="screen">

    <!--[if lt IE 9]>
    <link href="<?php echo get_template_directory_uri(); ?>/css/ie.css" rel="stylesheet" media="screen">
